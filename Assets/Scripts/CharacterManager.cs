...
public class CharacterManager : MonoBehaviour {
    ...
    [SerializeField]
    CharacterPartRenderer[] bodyPartsRenderers;

    [SerializeField]
    CharacterPartRenderer[] hatSpriteRenderers;

    [SerializeField]
    CharacterPartRenderer[] weaponSpriteRenderers;

    [SerializeField]
    CharacterPartRenderer[] extrasSpriteRenderers;

    CharactersItemsSO m_charactersSO;
